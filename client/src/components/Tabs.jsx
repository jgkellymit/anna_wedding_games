...
export default function Tabs({ activeTab, setActiveTab, onLogout, onLogoutClick, userName }) {
    ...
    <div className="w-full bg-white shadow-md sticky top-0 z-10">
      <div className="max-w-[850px] w-full mx-auto">
        <div className="flex items-center justify-between w-full px-6 py-2">
          <span className="whitespace-nowrap" style={{ color: 'black', marginLeft: '8px', fontWeight: 700, fontStyle: 'italic' }}>{userName}</span>
